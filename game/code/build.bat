...
set CommonCompilerFlags=-MTd -nologo -Gm- -GR- -EHa- -Od -Oi -WX -W4 -wd4201 -wd4100 -wd4189 -wd4456 -wd4505 -wd4996 -wd4312 -DSNAKE_INTERNAL=0 -DSNAKE_SLOW=1 -DSNAKE_WIN32=1 -DSAVE_IMAGES=1 -DOPENGL=0 -FC -Z7
