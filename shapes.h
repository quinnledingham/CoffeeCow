...
void draw_rect(Rect rect, v4 color) { draw_rect(rect.coords, 0, rect.dim, color); }
void draw_rect(Rect rect, Bitmap *bitmap) { draw_rect(rect.coords, 0, rect.dim, bitmap); }
void draw_rect(Rect rect, r32 rotation, Bitmap *bitmap) { draw_rect(rect.coords, rotation, rect.dim, bitmap); }
