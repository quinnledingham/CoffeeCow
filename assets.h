...
internal void*
find_asset(Assets *assets, u32 type, u32 index) {
    return &assets->types[type].data[index].memory;
}
...
inline Audio* find_audio(Assets *assets, u32 index) { return (Audio*)find_asset(assets, ASSET_TYPE_AUDIO, index); }
