...
set LFs2= -incremental:no -opt:ref shell32.lib opengl32.lib sdl-vc\lib\x64\SDL2main.lib sdl-vc\lib\x64\SDL2.lib /subsystem:windows

cl %CFs2% game.cpp /link %LFs2% /out:build\coffee_cow.exe
